...
-- |
data HeronDataConfig = HeronDataConfig
...
-- | display the config
instance P.Show HeronDataConfig where
  show c =
    T.printf
...
-- | constructs a default HeronDataConfig
--
-- configHost:
--
-- @https://app.herondata.io@
--
-- configUserAgent:
--
-- @"heron-data/0.1.0.0"@
--
newConfig :: IO HeronDataConfig
newConfig = do
    logCxt <- initLogContext
    return $ HeronDataConfig
        { configHost = "https://app.herondata.io"
        , configUserAgent = "heron-data/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => HeronDataConfig -> auth -> HeronDataConfig
addAuthMethod config@HeronDataConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: HeronDataConfig -> IO HeronDataConfig
...
withStderrLogging :: HeronDataConfig -> IO HeronDataConfig
...
withNoLogging :: HeronDataConfig -> HeronDataConfig
...
data HeronDataRequest req contentType res accept = HeronDataRequest
  { rMethod  :: NH.Method   -- ^ Method of HeronDataRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of HeronDataRequest
  , rParams   :: Params -- ^ params of HeronDataRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (HeronDataRequest req contentType res accept) NH.Method
rMethodL f HeronDataRequest{..} = (\rMethod -> HeronDataRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (HeronDataRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f HeronDataRequest{..} = (\rUrlPath -> HeronDataRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (HeronDataRequest req contentType res accept) Params
rParamsL f HeronDataRequest{..} = (\rParams -> HeronDataRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (HeronDataRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f HeronDataRequest{..} = (\rAuthTypes -> HeronDataRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => HeronDataRequest req contentType res accept -> param -> HeronDataRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: HeronDataRequest req contentType res accept -> param -> HeronDataRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: HeronDataRequest req contentType res accept -> param -> HeronDataRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** HeronDataRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> HeronDataRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = HeronDataRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     HeronDataRequest req contentType res accept
  -> [NH.Header]
  -> HeronDataRequest req contentType res accept
...
removeHeader :: HeronDataRequest req contentType res accept -> [NH.HeaderName] -> HeronDataRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => HeronDataRequest req contentType res accept -> HeronDataRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => HeronDataRequest req contentType res accept -> HeronDataRequest req contentType res accept
...
addForm :: HeronDataRequest req contentType res accept -> WH.Form -> HeronDataRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: HeronDataRequest req contentType res accept -> NH.Part -> HeronDataRequest req contentType res accept
...
_setBodyBS :: HeronDataRequest req contentType res accept -> B.ByteString -> HeronDataRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: HeronDataRequest req contentType res accept -> BL.ByteString -> HeronDataRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => HeronDataRequest req contentType res accept -> P.Proxy authMethod -> HeronDataRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> HeronDataRequest req contentType res accept
    -> IO (HeronDataRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> HeronDataConfig
  -> IO (HeronDataRequest req contentType res accept)
_applyAuthMethods req config@(HeronDataConfig {configAuthMethods = as}) =
  foldlM go req as
  where
