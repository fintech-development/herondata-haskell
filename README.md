## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Heron Data API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Heron Data API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | HeronData                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | heron-data                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | HeronDataConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | HeronDataRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| HeronData.Client    | use the "dispatch" functions to send requests       |
| HeronData.Core      | core functions, config and request types            |
| HeronData.API       | construct api requests                              |
| HeronData.Model     | describes api models                                |
| HeronData.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| HeronData.ModelLens | lenses for model fields                             |
| HeronData.Logging   | logging functions and utils                         |
